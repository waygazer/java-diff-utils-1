...
public class EncryptWithCertificate {
     ...
     * The resulting PDF
     */
    public static String RESULT1 = "results/chapter12/certificate_encryption.pdf";
    /**
     * The resulting PDF
     */
    public static String RESULT2 = "results/chapter12/certificate_decrypted.pdf";
    /**
     * The resulting PDF
     */
    public static String RESULT3 = "results/chapter12/certificate_encrypted.pdf";

    /**
     * A properties file that is PRIVATE. You should make your own properties
     * file and adapt this line.
     */
    public static String PATH = "c:/Users/hp/Documents/key.properties";
    /**
    ...
    public void createPdf(String filename)
        ...
        Certificate cert1 = getPublicCertificate("C:\\Users\\hp\\Documents\\trejhara.cer");
    ...
    public PrivateKey getPrivateKey() throws GeneralSecurityException, IOException {
        ...
        String path = "C:\\Users\\hp\\Documents\\.keystore";

        KeyStore ks = KeyStore.getInstance(KeyStore.getDefaultType());
        ks.load(new FileInputStream(path), "trejhara".toCharArray());
        PrivateKey pk = (PrivateKey) ks.getKey("trejhara", "trejhara".toCharArray());
        return pk;
    }
    ...
    public void decryptPdf(String src, String dest)
        ...
        PdfReader reader = new PdfReader(src,
                ...
                getPublicCertificate("C:\\Users\\hp\\Documents\\trejhara.cer"), getPrivateKey(), "BC");
    ...
    public void encryptPdf(String src, String dest)
        ...
        Certificate cert = getPublicCertificate("C:\\Users\\hp\\Documents\\trejhara.cer");
